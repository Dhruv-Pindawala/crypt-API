...
class Message(models.Model):
    sender = models.ForeignKey('user_control.CustomUser', related_name='message_sender', on_delete=models.CASCADE) # message sent also deletes when user is deleted
    ...
    class Meta:
        ordering = ("-created_at",) # newest comes first
...
class MessageAttachment(models.Model):
    ...
    class Meta:
        ordering = ("created_at",) # oldest comes first